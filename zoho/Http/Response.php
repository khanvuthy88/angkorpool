...
use Zoho\Exception\ZohoException;
...
class Response
{
    ...
    protected function parseResponse()
    {
        ...
        if ($xml === false) {
            throw new ZohoException("Zoho CRM response could not be parsed as XML.", 0000);
        }
        ...
        elseif (isset($xml->result->message) && isset($xml->result->code)) {
            ...
            throw new ZohoException("Unknown Zoho response format.");
        }
    }
